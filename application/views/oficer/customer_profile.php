                  ...
                  <?php include('incs/nav_profile.php'); ?>
                    ...
                    <div class="tab-content padding-0">
                        ...
                        <div class="tab-pane active" id="Basic">
                            ...
                            <input type="number" name="phone_no" value="<?php echo $customer_profile->phone_no; ?>" placeholder="Eg,7538, 6283" readonly autocomplete="off" class="form-control input-sm" required >
                                </div>
