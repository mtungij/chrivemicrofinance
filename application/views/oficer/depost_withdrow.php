                ...
                <div class="col-lg-6">
                  ...
                  <div class="col-lg-12">
                    ...
                    <?php //echo form_open("oficer/search_customerData",['id'=>'login_form']); ?>
                            <div class="sam">
                                <select type="number" class="form-control select2" onchange="location = this.value;" name="" required>
                                    <option>Search Customer</option>
                                    <?php foreach ($customery as $customer_datas): ?>
                                    <option value="<?php echo base_url("oficer/data_with_depost/{$customer_datas->customer_id}") ?>"><?php echo $customer_datas->f_name; ?> <?php echo $customer_datas->m_name; ?> <?php echo $customer_datas->l_name; ?> / <?php echo $customer_datas->customer_code; ?> </option>
                                    <?php endforeach; ?>
                                </select>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    ...
                    <input type="date" class="form-control" readonly value="<?php echo $date; ?>" name="with_date" required>       
                    </div>
                   
            </div>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" onclick="this.disabled=true;this.value='Submitting...'; this.form.submit();">Withdrawal</button>
