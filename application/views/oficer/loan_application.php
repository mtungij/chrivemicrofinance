                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-2 col-12">
                                 ...
                                 <select type="number" class="form-control select2" name="customer_id" onchange="location = this.value;" required>
                                     ...
                                     <option value="<?php echo base_url("oficer/apply_loan/{$customers->customer_id}") ?>"><?php echo $customers->f_name; ?> <?php echo $customers->m_name; ?> <?php echo $customers->l_name; ?> / <?php echo $customers->customer_code; ?></option>
                                 <?php endforeach; ?>
                                 </select>
                                </div>
                                 <div class="col-lg-2 col-12">
