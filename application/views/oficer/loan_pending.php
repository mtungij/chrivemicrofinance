        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      //                     exit();
                                    ...
                                    <td><a href="javascript:;"><?php echo $loan_pendings->f_name; ?> <?php echo substr($loan_pendings->m_name, 0,1); ?> <?php echo $loan_pendings->l_name; ?></a></td>
                ...
                <div class="btn-group" role="group">
                  ...
                  <a class="dropdown-item" href="<?php echo base_url("oficer/edit_loan/{$loan_pendings->loan_id}") ?>" ><i class="icon-pencil">Edit</i></a>
