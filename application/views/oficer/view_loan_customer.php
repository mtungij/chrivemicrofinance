...
<input type="text" name="" readonly autocomplete="off"  class="form-control input-sm" value="<?php echo $loan_form->reason; ?>">
    ...
    <button type="submit" class="btn btn-primary" onclick="this.disabled=true;this.value='Submitting...'; this.form.submit();"><i class="icon-drawer">Aprove</i></button>

 
    <a href="<?php echo base_url("oficer/reject_loan/{$loan_form->loan_id}"); ?>" class="btn btn-danger">Reject</a>
     <a href="<?php echo base_url("oficer/loan_pending"); ?>" class="btn btn-primary">Back</a>
    </div>
