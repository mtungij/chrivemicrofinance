        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                         <div class="header">
                            <h2>Loan Withdrawal / <?php if ($blanch_id =='all') {
                                echo "ALL BRANCH";
                            }else{
                            ...
                            <div class="pull-right">
                                ...
                                <?php if (count($data) > 0) {
                                 ?>
                                 <a href="<?php echo base_url("admin/print_loan_withdrawalFilter/{$blanch_id}/{$from}/{$to}") ?>" class="btn btn-primary" target="_blank"><i class="icon-printer">Print</i></a>
                             <?php }else{ ?>
                                <?php } ?>
                            </div>    
                         </div>
