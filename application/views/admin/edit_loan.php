...
<?php if ($das = $this->session->flashdata('massage')): ?> 
 ...
 <div class="tab-content padding-0">
         <div class="tab-pane active" id="Basic">
           <div class="card">
            <div class="body">
    <?php echo form_open("admin/modify_loan_aplication/{$loan_data->loan_id}/"); ?>
<h6>(1).Loan Aplication Form</h6>
            ...
            <a href="<?php echo base_url("admin/loan_pending"); ?>" class="btn btn-primary"><i class="icon-arrow-left"></i></a>
        <?php }else{ ?>
        <a href="<?php echo base_url("admin/all_loans_details/{$customer_id}"); ?>" class="btn btn-primary"><i class="icon-arrow-left"></i></a>
            <?php } ?>
            </div>
                <?php echo form_close();  ?>
                    </div>
...
<h6>(2).Guarantors</h6>
  <div class="pull-right">
                        ...
                        <a href="<?php echo base_url("admin/delete_sponser_edit_loan/{$sponsers->sp_id}/{$customer_id}/{$loan_data->loan_id}"); ?>" onclick="return confirm('Are you sure?')" class="btn btn-sm btn-danger"><i class="icon-trash"></i></a>
                                             </td>
                                        </tr>
                                        <?php } ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("admin/modify_sponser_edit_loan/{$sponsers->sp_id}/{$customer_id}/{$loan_data->loan_id}"); ?>
  ...
  <!--   <input type="hidden" name="customer_id"  id="customer_id" value="<?php echo $customer_id; ?>">
    ...
    <div class="col-lg-6 col-6">
      <span>Phone number:</span>  
        <input type="number" class="form-control" value="<?php echo $sponsers->sp_phone_no; ?>" id="sp_phone_no" placeholder="Enter Phone number" name="sp_phone_no" autocomplete="off">
    </div>
...
<h6>(3).Collateral</h6>
  <div class="pull-right">
     ...
     ?>
        ...
        <?php }else{ ?>
            <?php } ?>
                  ...
                  <a href="<?php echo base_url("admin/delete_colateral_edit_loan/{$collaterals->col_id}/{$loan_data->loan_id}"); ?>" onclick="return confirm('Are You Sure?')" title="Delete" class="btn btn-danger btn-sm"><i class="icon-trash"></i></a>
    ...
    <?php echo form_open("admin/modify_collateral_edit_loan/{$collaterals->col_id}/{$loan_data->loan_id}"); ?>
            <div class="modal-body">
                <div class="row clearfix">
             <div class="col-lg-12 col-12">
...
<h6>(4).Local government</h6>
  ...
  <div class="modal fade" id="addcontact1<?php echo $local_oficer->attach_id ?>" tabindex="-1" role="dialog">
    ...
    <?php echo form_open("admin/modify_localgovernment/{$local_oficer->attach_id}/{$loan_data->loan_id}"); ?>
            <div class="modal-body">
                <div class="row clearfix">
             <div class="col-lg-6 col-6">
        <div class="form-group">
...
$.ajax({
url:"<?php echo base_url(); ?>admin/fetch_loan_fee_data",
method:"POST",
data:{category_id:category_id},
success:function(data)
{
...
<div class="modal fade" id="addcontact2" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("admin/create_sponser_edit_loan/{$customer_id}/{$loan_data->loan_id}"); ?>
            <div class="modal-body">
                <div class="row clearfix">
...
<div class="modal fade" id="addcontact3" tabindex="-1" role="dialog">
 ...
 <?php echo form_open("admin/create_collateral_edit_loan/{$loan_data->loan_id}"); ?>
      <div class="modal-body">
        <div class="row clearfix">    
        <div class="col-lg-12">
        <div class="form-group">
