                ...
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      <?php endforeach; ?>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td><b><?php //echo number_format($loan_total->total_loan); ?></b>0.00</td>
                                    <td></td>
                                    <td><b><?php //echo number_format($total_receved->total_depost); ?></b></td>
                                    <td>
                      <!--                   <b>
                        <?php if (($depost_loan->total_loan_depost + $depost_loan->total_double)  > $loan_total->total_loan) {
                        ?>
                        <?php echo number_format($loan_total->total_loan); ?> <b style="color:red;">(<?php echo number_format(($depost_loan->total_loan_depost  + $depost_loan->total_double) - $loan_total->total_loan) ?>)</b>
                        <?php }else{ ?>
                        <?php echo number_format($depost_loan->total_loan_depost + $depost_loan->total_double); ?>
                        <?php } ?>
                                    </b> --> 0.00
                                </td>
                                <td>
                           <!--          <b>
                            <?php if (($depost_loan->total_loan_depost + $depost_loan->total_double) > $loan_total->total_loan) {
                         ?>
                         0 <b style="color:red;">(<?php echo ($depost_loan->total_loan_depost + $depost_loan->total_double) - $loan_total->total_loan ?>)</b>
                        <?php }else{ ?>
                        <?php echo number_format($loan_total->total_loan - ($depost_loan->total_loan_depost + $depost_loan->total_double)); ?>
                            <?php } ?></b> --> 0.00
                        </td>
                            <td>
