        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2>Customer Photo & Signature</h2>
                        </div>
                        <div class="body">
                            ...
                            <input type="file"  name="passport" placeholder="Monthly Income" class="form-control input-sm" data-required="true">
                                    ...
                                    <div class="col-lg-6 form-group-sub">
                                    <label class="form-control-label">Customer Signature:</label>
                            <input type="file"  name="signature"  class="form-control input-sm" data-required="true">
                                ...
                                <a href="<?php echo base_url("oficer/customer_profile/{$data_customer->customer_id}") ?>" class="btn btn-info btn-elevate btn-pill">Finish</a>
                                </div>
