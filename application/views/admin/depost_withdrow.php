                ...
                <div class="col-lg-6">
                  ...
                  <div class="col-lg-12">
                    ...
                    <?php //echo form_open("admin/search_customerData",['id'=>'login_form']); ?>
                            <div class="sam">
                                <select type="number" class="form-control select2" name="" onchange="location = this.value;" required>
                                    <option>Search Customer</option>
                                    <?php foreach ($customery as $customer_datas): ?>
                                    <option value="<?php echo base_url("admin/data_with_depost/{$customer_datas->customer_id}") ?>"><?php echo $customer_datas->f_name; ?> <?php echo $customer_datas->m_name; ?> <?php echo $customer_datas->l_name; ?> / <?php echo $customer_datas->customer_code; ?> </option>
                                    <?php endforeach; ?>
                                </select>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" value="<?php echo number_format($out_stand->total_out); ?>.00" readonly style="color:red"> 
                 <?php }else{ ?>
                    ...
                    <input type="date" class="form-control" readonly value="<?php echo $date; ?>" name="deposit_date" required>       
                    </div>
            ...
            <div class="modal-footer">
                 <?php if (@$today_dep->deposit_day == TRUE) {
                  ?>
            <button type="submit" class="btn btn-primary" onclick="this.disabled=true;this.value='Submitting...'; this.form.submit();">Deposit</button>
 ...
 <div class="modal fade" id="addcontact2" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="submit" onclick="this.disabled=true;this.value='Submitting...'; this.form.submit();" class="btn btn-primary">Withdrawal</button>
