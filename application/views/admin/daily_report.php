                                 ...
                                 <?php $loan_pending = $this->queries->get_system_loan_return_company($data_account_datas->comp_id,$data_account_datas->receive_trans_id);
                                  ...
                                  ?>
                                   <?php foreach ($loan_pending as $loan_pendings): ?>
                                    ...
                                    <?php $from_main_account = $this->queries->get_transaction_from_mainAccount_company($data_account_datas->blanch_id,$data_account_datas->receive_trans_id); ?>
                                    ...
                                    <tr>
                                     ...
                                     <?php endforeach; ?>
                                     <?php $from_blanch_blanch = $this->queries->get_transaction_from_company($data_account_datas->blanch_id,$data_account_datas->receive_trans_id);
                                     // echo "<pre>";
