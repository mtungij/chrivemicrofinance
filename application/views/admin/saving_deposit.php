...
<?php include('incs/side.php'); ?>
    ...
    <div id="main-content">
        <div class="container-fluid">
            ...
            <a href="<?php echo base_url("admin/deposit_lecord"); ?>" class="btn btn-primary"><i class="icon-list"></i></a> 
                            </div>   
                             </div>
                          <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <a href="<?php echo base_url("admin/deposit_saving/{$saving_deposits->id}"); ?>" class="btn btn-primary btn-sm" onclick="return confirm('Are You Sure?')" title="depost"><i class="icon-pencil"></i></a>
