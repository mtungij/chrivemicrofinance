        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                         <div class="header">
                            <h2>Agent transaction  Deposit / <?php if ($blanch_id == 'all') {
                                echo "ALL BRANCH";
                            }else{
            ...
            <a href="<?php echo base_url("admin/deposit_lecord"); ?>" class="btn btn-sm btn-secondary"><i class="icon-arrow-left"></i></a>  
                            </div>   
                             </div>
                          <div class="body">
                                ...
                                <table class="table table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $saving_deposits->f_name; ?></td>
...
<div class="modal fade" id="addcontact3" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("admin/filter_deposit_miamala"); ?>
