            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php echo form_open_multipart("admin/deposit_loan_saving/{$data_saving->id}",['id'=>'login_form']); ?>
                            <div class="row">
                            ...
                            <input type="date" name="deposit_date" class="form-control" value="<?php echo $date; ?>" required>
                             ...
                             <a href="<?php echo base_url("admin/saving_deposit"); ?>" class="btn btn-primary"><i class="icon-arrow-left"></i></a>
...
{
$.ajax({
url:"<?php echo base_url(); ?>admin/fetch_data_loanActive_data_loanwithdrawal",
method:"POST",
