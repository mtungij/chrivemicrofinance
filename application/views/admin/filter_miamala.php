        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                         <div class="header">
                            <h2>Agent transaction / <?php if ($blanch_id == 'all') {
                                echo "ALL BRANCH";
                            }else{
                                echo $blanch_data->blanch_name;
            ...
            <a href="<?php echo base_url("admin/saving_deposit"); ?>" class="btn btn-sm btn-secondary"><i class="icon-arrow-left"></i></a>  
                            </div>   
                             </div>
                          <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <a href="<?php echo base_url("admin/deposit_saving/{$saving_deposits->id}/{$from}/{$to}"); ?>" class="btn btn-primary btn-sm" onclick="return confirm('Are You Sure?')" title="depost"><i class="icon-pencil"></i></a>
                                    <a href="<?php echo base_url("admin/remove_miamala_agent/{$saving_deposits->id}"); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure to Delete?')" title="Delete"><i class="icon-trash"></i></a>
...
<div class="modal fade" id="addcontact3" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open("admin/filter_miamala"); ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <input type="number" name="amount" autocomplete="off" class="form-control" placeholder="Enter Amount" required>
                    ...
                    <!-- <div class="col-lg-4 col-6">
            <span>*Time</span>
            <input type="time" name="time" autocomplete="off" placeholder="time" class="form-control" required>
                </div> -->
